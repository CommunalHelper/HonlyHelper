...
namespace Celeste.Mod.HonlyHelper {
    ...
    public class FireFly : FlyingBug {
        ...
        private Color NormalColor = new(0.05f, 0.10f, 0.05f);
        private readonly float BlinkTimerMax = 1.5f;
        private readonly float RoamRadius = 24;
        public float BlinkTimer;
        private Vector2 LongtermFlightGoal;
        private bool BlinkBlonkin = false;
        private readonly float FriendFindRadius = 40f;
        private readonly float FriendInfluenceRadius = 64f;
